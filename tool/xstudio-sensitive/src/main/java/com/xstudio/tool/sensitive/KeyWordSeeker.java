...
import com.xstudio.tool.sensitive.processor.*;
import com.xstudio.tool.sensitive.util.AnalysisUtil;
import com.xstudio.tool.sensitive.util.EmojiUtil;
...
public class KeyWordSeeker {
     ...
     */
    public KeyWordSeeker(Set<KeyWord> sensitiveWords) {
    ...
    public String toString() {
        return "KeyWordSeeker [sensitiveWords=" + sensitiveWords + ", wordsTree=" + wordsTree
