 ...
 * 示例：
 *  SOAPMessage reply = ......
 *  try (LoggingOutputStream loggingOutputStream = new LoggingOutputStream(logger, Level.INFO)) {
 *     reply.writeTo(loggingOutputStream);
 *  }
 *
 * @author xiaobiao
 */
public class SoapLogging extends OutputStream {
     ...
     *                                  is  null.
     */
    public SoapLogging(final Logger log, final Level level)
